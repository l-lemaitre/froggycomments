<?php
	class FroggyCommentsDisplayProductTabContentController {
		// On crée un constructeur pour récupérer les données des variables et méthodes de la classe principale du module (voir fichier froggycomments.php ligne 121)
		...
		public function processProductTabContent() {
			...
			if(Tools::isSubmit('froggy_pc_submit_comment')) {
				...
				// On utilise l’ObjectModel FroggyComment pour insérer les données dans la bdd (voir fichier FroggyComment.php lignes 5 à 41)
		...
		// On déclare la méthode assignProductTabContent pour afficher sur la page produit les commentaires laissés par les clients
		public function assignProductTabContent() {
			...
			// On initialise la variable public product avec une instance du produit affiché (Voir ligne 190, 263 et dans le fichier displayProductTabContent.tpl ligne 17)
