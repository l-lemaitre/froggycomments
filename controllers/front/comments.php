...
class FroggyCommentsCommentsModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        // On récupére les paramètres id_product et module_action dans des variables (voir fichier
        // displayProductTabContent.tpl lignes 16 et 17)
    ...
    {
        // On appelle la méthode statique getProductNbComments de la classe FroggyComment pour récupérer le nombre
        // de commentaires du produit (voir fichier FroggyComment.php ligne 44)
        ...
        // La variable limit_start définit à partir de quelle ligne commence la sélection de la page courante. Par
        // défaut si $page = 1 alors $limit_start = 0, si $page = 2 alors $limit_start = (2-1)*5 = 5
