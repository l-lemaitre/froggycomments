...
{
    // On déclare la méthode constructeur en visibilité publique pour initialiser les valeurs suivantes à chaque
    ...
    public function __construct()
    {
        ...
        $this->version = "0.4.0"; // Version du module
        ...
        $this->description =
            $this->l('With this module, your customers will be able to grade and comments your products');
    ...
    public function install()
    {
        ...
        if (!$this->loadSQLFile($sql_file)) {
            // Si la méthode install d’un module retourne false PrestaShop affiche automatiquement un message d’erreur
            // pour indiquer au marchand qu’un problème est survenu
            return false;
        }
        ...
        if (!$this->registerHook('displayProductTabContent') || !$this->registerHook('displayBackOfficeHeader') ||
            !$this->registerHook('displayAdminProductsExtra') || !$this->registerHook('displayAdminCustomers') ||
    ...
    // On ajoute la méthode installTab pour créer un nouvel onglet dans notre panneau d’administration (voir ligne ?? et
    // fichier AdminFroggyCommentsController.php)
    ...
    // On crée la méthode getHookController qui sera chargée d’instancier un contrôleur de hook et de retourner
    // l’instance
    ...
    public function getContent()
    {
        ...
        // On ajoute un mini-dispatcher Ajax utilisant le paramètre ajax_hook que nous avons défini dans le fichier
        // displayAdminProductsExtra.tpl ligne 32
