...
<div class="rte">
	{foreach from=$comments item=comment}
        <div class="froggycomments-comment">
        	<img src="http://www.gravatar.com/avatar/{$comment.email|trim|strtolower|escape:'htmlall':'UTF-8'|md5}?s=45" class="pull-left img-thumbnail froggycomments-avatar" />
	...
	<div class="rte">
		...
		<p align="center"><a href="{$link->getModuleLink('froggycomments', 'comments', $params)|escape:'htmlall':'UTF-8'}">{l s='See all comments' mod='froggycomments'}</a></p>
	</div>
